...
public:
    ...
    Configs(int argc, char ** argv){
        ...
        items.push_back(new ConfigItem<unsigned int>("queue_num", "-qn", 128, "Number of NVME queue pairs", queue_num));
        ...
        items.push_back(new ConfigItem<unsigned int>("embedding_vec_dim", "-ed", 64, "embedding dimension", embedding_vec_dim));
