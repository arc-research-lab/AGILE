...
public:
    ...
    Configs(int argc, char ** argv){
        ...
        items.push_back(new ConfigItem<std::string>("output_file", "-o", "res-pr.txt", "output file", output_file));
        ...
        items.push_back(new ConfigItem<unsigned int>("weight_offset", "-wo", 0, " weight_offset", weight_offset));
        items.push_back(new ConfigItem<float>("damping", "-d", 0.85, "damping factor", damping));
        items.push_back(new ConfigItem<unsigned int>("ssd_block_num", "-sbn", 1048576, "number of ssd blocks", ssd_block_num));
        items.push_back(new ConfigItem<unsigned int>("iteration", "-it", 20, "number of iterations", iteration));
