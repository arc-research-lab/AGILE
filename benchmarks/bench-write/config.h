...
public:
    ...
    unsigned int ssd_num;
    unsigned int ssd_off;
    unsigned int req_pre_dev;
    ...
    Configs(int argc, char ** argv){
        ...
        items.push_back(new ConfigItem<unsigned int>("queue_depth", "-qd", 1024, "Depth of each NVME queue", queue_depth));
        ...
        // application config
        items.push_back(new ConfigItem<unsigned int>("ssd_block_num", "-sbn", 65536*8*64, "Number of ssd blocks", ssd_block_num));
        items.push_back(new ConfigItem<unsigned int>("ssd_num", "-sn", 1, "Number of ssd devices", ssd_num));
        items.push_back(new ConfigItem<unsigned int>("ssd_off", "-so", 0, "Offset of ssd devices", ssd_off));
        items.push_back(new ConfigItem<unsigned int>("req_pre_dev", "-rn", 1024, "Number of requests", req_pre_dev));
