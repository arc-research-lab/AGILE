...
// ---- Convenience macros ------------------------------------------------------
#define MTLOG_TRACE(...)    ::mtlog::log(::mtlog::level::trace,   {}, src_loc::current(), __VA_ARGS__)
#define MTLOG_DEBUG(...)    ::mtlog::log(::mtlog::level::debug,   {}, src_loc::current(), __VA_ARGS__)
#define MTLOG_INFO(...)     ::mtlog::log(::mtlog::level::info,    {}, src_loc::current(), __VA_ARGS__)
#define MTLOG_WARN(...)     ::mtlog::log(::mtlog::level::warn,    {}, src_loc::current(), __VA_ARGS__)
#define MTLOG_ERROR(...)    ::mtlog::log(::mtlog::level::error,   {}, src_loc::current(), __VA_ARGS__)
#define MTLOG_CRITICAL(...) ::mtlog::log(::mtlog::level::critical,{}, src_loc::current(), __VA_ARGS__)
