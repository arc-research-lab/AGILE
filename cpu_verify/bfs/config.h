...
public:
    ...
    Configs(int argc, char ** argv){
        ...
        items.push_back(new ConfigItem<unsigned int>("edge_num", "-en", 68993773, "Total edge count of the graph", edge_num));
        ...
        items.push_back(new ConfigItem<std::string>("output_file", "-o", "cpu-res-bfs.bin", "Output file", output_file));
